...
const Navbar = () => {
    ...
    return (
        <>
            {logoutmodal && <DeleteModal loading={isLoading} onClick={LogoutFunc} setdeleteModal={setlogoutModal} title={'Logout'} details={'Do you really want to logout?'} />}
            ...
            <div className='navbar_wrapper'>
                <div className='container navbar_content_wrapper'>
                    ...
                    <div className='navbar_logout_wrapper'>
                        ...
                        <img onClick={(() => setlogoutModal(true))} src={logout} />

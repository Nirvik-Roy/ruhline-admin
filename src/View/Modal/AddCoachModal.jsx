                    ...
                    <div className='modal_input_grid_wrapper'>
                        ...
                        <div>
                            ...
                            <small style={{
                                ...
                                marginTop: '5px',
                                color: 'red'
                            }}>{addCoachError?.email ? addCoachError.email : emailerrorMessage}</small>
                        </div>
                        ...
                        <div className='input_form' style={{
                            ...
                            <small style={{
                                ...
                                marginTop: '5px',
                                color: 'red'
                            }}>{addCoachError?.password ? addCoachError.password : passwordMsg}</small>
                        </div>
                        ...
                        <div className='input_form confirm_input_form'>
                            ...
                            <div className='phone_input_Wrapper656'>
                                ...
                                <small style={{
                                    ...
                                    marginTop: '5px',
                                    color: 'red'
                                }}>{addCoachError?.phone_country_code_id && addCoachError.phone_country_code_id}</small>
                            </div>
                            <small style={{
                                fontSize: '0.7rem',
                                display: 'block',
                                color: 'red',
                                marginLeft: 'auto'
                            }}>{addCoachError?.phone ? addCoachError.phone : contacterrorMessage}</small>
                        </div>
                        ...
                        <div className='input_form'>
                            ...
                            <small style={{
                                ...
                                color: 'red',
                                marginLeft: 'auto'
                            }}>{addCoachError?.gender && addCoachError.gender}</small>
                        </div>

...
const DisputeViewModal = ({ setdisputes, singleDisputeData, changeDisputeStatus, loading, changeLoading }) => {
            ...
            <div className='modal_div' style={{
                ...
                {!loading && <>
                    ...
                    {singleDisputeData?.status == 'open' && <div className='change_cancel_wrapper' onClick={(() => changeDisputeStatus())}>
                        ...
                        <Button loading={changeLoading} loadingText='Solving...' children={'Mark as solved'} />
                    </div>}
